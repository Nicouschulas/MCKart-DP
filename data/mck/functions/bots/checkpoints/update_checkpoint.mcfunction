...
data modify entity @s HandItems[0].components.checkpoints append from entity @s HandItems[0].components.checkpoints[0]
data remove entity @s HandItems[0].components.checkpoints[0]

data modify entity @s HandItems[0].components.modes append from entity @s HandItems[0].components.modes[0]
data remove entity @s HandItems[0].components.modes[0]

execute store result score @s mck_drive_mode run data get entity @s HandItems[0].components.modes[0]
...
execute store result score temp mck_temp run data get entity @s HandItems[0].components.maxcheckpoints
