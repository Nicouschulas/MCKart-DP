...
execute if score @s mck_item1 matches 14 if score @s mck_item1_count matches 161 on passengers if entity @s[tag=item_mount] run scoreboard players operation @s mck_item_mount = temp mck_temp
