...
execute if score temp mck_temp matches 1.. run data modify storage lobby normal append from storage lobby temp
execute if score temp mck_temp matches 1.. run scoreboard players remove temp mck_temp 1
execute if score temp mck_temp matches 1.. run function mck:resources/lobby_normal