...
execute if data storage tracks selections[0] if data storage temp sel_track run data modify storage lobby normal[0].track set from storage temp sel_track
execute if data storage tracks selections[0] if data storage temp sel_track run function mck:lobby/normal/start/prepare
