# set trafficlights
data modify storage temp trafficlights set from storage lobby ranked[0].track.tag.data.trafficlights
execute store result score angle mck_temp run data get storage lobby ranked[0].track.tag.data.startangle
...
execute if score lobbystarttime mck_temp matches 0 store result score lobbysafetime mck_temp run data get storage lobby ranked[0].track.tag.data.safetime
execute if score lobbystarttime mck_temp matches 0 run function mck:bossbar/r_prepare_status2
...
function mck:bossbar/r_status1