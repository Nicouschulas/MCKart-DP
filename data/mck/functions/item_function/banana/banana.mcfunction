summon item ~ ~ ~ {PickupDelay:32767,Invulnerable:1b,Motion:[0.0,0.35,0.0],Tags:["banana"],Item:{id:"minecraft:carrot_on_a_stick",Count:1b,components:{minecraft:custom_model_data:1003}}}
