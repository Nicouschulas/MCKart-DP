...
data modify storage temp text append value '{"nbt":"pl2","storage":"temp","color":"#BCD5D6","bold":false}'
...
data modify storage temp text append value '{"nbt":"time2[]","storage":"temp","interpret":true,"color":"white","bold":false,"separator":""}'