...
data modify storage temp text append value '{"nbt":"pl7","storage":"temp","color":"#BCD5D6","bold":false}'
...
data modify storage temp text append value '{"nbt":"time7[]","storage":"temp","interpret":true,"color":"white","bold":false,"separator":""}'