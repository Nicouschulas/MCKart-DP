...
data modify storage temp text append value '{"nbt":"pl9","storage":"temp","color":"#BCD5D6","bold":false}'
...
data modify storage temp text append value '{"nbt":"time9[]","storage":"temp","interpret":true,"color":"white","bold":false,"separator":""}'