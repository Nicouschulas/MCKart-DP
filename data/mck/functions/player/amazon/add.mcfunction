scoreboard players add id mck_goods_id 1
scoreboard players operation in mck_db_bit = id mck_goods_id
scoreboard players operation amazon mck_goods_id = id mck_goods_id


function mck:database/good_add
