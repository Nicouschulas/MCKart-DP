...
execute unless score @s mck_item1 matches 0 if score @s mck_item2 matches 0 run data modify block 0 0 0 Items[0].components set value {"item2":1}
...
execute if score @s mck_itembox matches 2 if score @s mck_item2 matches 0 run data modify block 0 0 0 Items[0].components set value {"item2":1}
...
execute if score @s mck_item1 matches 0 run data modify block 0 0 0 Items[0].components set value {"item1":1}
