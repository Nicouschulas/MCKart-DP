...
execute if score selected mck_temp matches 1 if score temp mck_temp < maxplayersranked mck_admin_settings store result score @s mck_lobby run data get storage lobby ranked[0].id
...
execute if score selected mck_temp matches 2 if score temp mck_temp < maxplayersranked mck_admin_settings store result score @s mck_lobby run data get storage lobby ranked[1].id
...
execute if score selected mck_temp matches 3 if score temp mck_temp < maxplayersranked mck_admin_settings store result score @s mck_lobby run data get storage lobby ranked[2].id
...
execute if score selected mck_temp matches 4 if score temp mck_temp < maxplayersranked mck_admin_settings store result score @s mck_lobby run data get storage lobby ranked[3].id
...
execute if score selected mck_temp matches 5 if score temp mck_temp < maxplayersranked mck_admin_settings store result score @s mck_lobby run data get storage lobby ranked[4].id
...
execute if score selected mck_temp matches 6 if score temp mck_temp < maxplayersranked mck_admin_settings store result score @s mck_lobby run data get storage lobby ranked[5].id
...
execute if score selected mck_temp matches 7 if score temp mck_temp < maxplayersranked mck_admin_settings store result score @s mck_lobby run data get storage lobby ranked[6].id
...
execute if score selected mck_temp matches 8 if score temp mck_temp < maxplayersranked mck_admin_settings store result score @s mck_lobby run data get storage lobby ranked[7].id
...
execute if score selected mck_temp matches 9 if score temp mck_temp < maxplayersranked mck_admin_settings store result score @s mck_lobby run data get storage lobby ranked[8].id
