...
execute if data storage temp list3[0] components:run function mck:player/stats/ranked/check_in_use
...
execute if data storage temp list1[0] components:run function mck:player/stats/ranked/sort