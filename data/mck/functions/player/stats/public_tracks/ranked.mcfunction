execute store result score id mck_temp run data get storage databases output.data.r_best.id
execute store result score time mck_temp run data get storage databases output.data.r_best.time
...
execute if score record mck_temp matches 1.. run function mck:player/stats/public_tracks/r_record
