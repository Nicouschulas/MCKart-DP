...
tellraw @a {"text":" "}
tellraw @a [{"text":" "},{"translate":"chat.alert.record.ranked","color":"#ADADAD","bold":false},{"nbt":"time1[]","storage":"temp","interpret":true,"separator":"","color":"#D6972B"},{"text":" ▶ ","color":"gray","bold":true},{"nbt":"time2[]","storage":"temp","interpret":true,"separator":"","color":"#FFDE59","bold":true}]
tellraw @a {"text":" "}
tellraw @a {"text":" "}
