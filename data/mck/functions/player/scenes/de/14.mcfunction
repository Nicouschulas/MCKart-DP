...
execute if score @s mck_scene_anim matches 520 run playsound custom:de.end.manager2 master @s ~ ~ ~ 0.7 1
...
execute if score @s mck_scene_anim matches 420..520 run title @s actionbar {"translate":"subtitles.manager56","color":"#DEDEDE","bold":false,"italic":false}
execute if score @s mck_scene_anim matches 320..420 run title @s actionbar {"translate":"subtitles.manager57","color":"#DEDEDE","bold":false,"italic":false}
execute if score @s mck_scene_anim matches 230..320 run title @s actionbar {"translate":"subtitles.manager58","color":"#DEDEDE","bold":false,"italic":false}
execute if score @s mck_scene_anim matches 170..230 run title @s actionbar {"translate":"subtitles.manager59","color":"#DEDEDE","bold":false,"italic":false}
