...
execute if score @s mck_scene_anim matches 2 run scoreboard players set @s mck_scene 8
...
execute if score @s mck_scene_anim matches 2.. run scoreboard players set @s mck_region_timer 1200
