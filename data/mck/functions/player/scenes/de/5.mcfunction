...
execute if score @s mck_scene_anim matches 1200 run scoreboard players set @s mck_sound_engine 460

execute if score @s mck_scene_anim matches 1200 run playsound custom:de.start.manager4 master @s ~ ~ ~ 1 1
...
execute if score @s mck_scene_anim matches 740 run tag @s remove phone_bar


execute if score @s mck_scene_anim matches 1125..1200 run title @s actionbar {"translate":"subtitles.manager24","color":"#DEDEDE","bold":false,"italic":false}
execute if score @s mck_scene_anim matches 1030..1125 run title @s actionbar {"translate":"subtitles.manager25","color":"#DEDEDE","bold":false,"italic":false}
execute if score @s mck_scene_anim matches 950..1030 run title @s actionbar {"translate":"subtitles.manager26","color":"#DEDEDE","bold":false,"italic":false}
execute if score @s mck_scene_anim matches 880..950 run title @s actionbar {"translate":"subtitles.manager27","color":"#DEDEDE","bold":false,"italic":false}
execute if score @s mck_scene_anim matches 790..880 run title @s actionbar {"translate":"subtitles.manager28","color":"#DEDEDE","bold":false,"italic":false}
execute if score @s mck_scene_anim matches 770..790 run title @s actionbar {"translate":"subtitles.manager29","color":"#DEDEDE","bold":false,"italic":false}
