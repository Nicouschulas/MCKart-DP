execute if score @s mck_scene_anim matches 240 run stopsound @s master custom:de.start.manager7
execute if score @s mck_scene_anim matches 240 run playsound custom:de.start.manager8 master @s ~ ~ ~ 1 1
...
execute if score @s mck_scene_anim matches 160..240 run title @s actionbar {"translate":"subtitles.manager43","color":"#DEDEDE","bold":false,"italic":false}
execute if score @s mck_scene_anim matches 70..160 run title @s actionbar {"translate":"subtitles.manager44","color":"#DEDEDE","bold":false,"italic":false}
