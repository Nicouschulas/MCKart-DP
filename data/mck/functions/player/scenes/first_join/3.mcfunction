...
execute if score @s mck_scene_anim matches 1 if score @s mck_use matches 1.. if score bool mck_temp matches 1 run scoreboard players set @s mck_scene 4
...
execute if score @s mck_scene matches 3 if score @s mck_scene_anim matches 2.. run scoreboard players remove @s mck_scene_anim 1