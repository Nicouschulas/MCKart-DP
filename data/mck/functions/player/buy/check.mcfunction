...
execute if score bool mck_temp matches 0 as @e[type=interaction,distance=..6,tag=this_interaction] at @s run summon firework_rocket ~ ~ ~ {LifeTime:-100,FireworksItem:{id:"firework_rocket",Count:1b,tag:{Fireworks:{Explosions:[{Type:4,Trail:1b,Colors:[I;8245533],FadeColors:[I;14614428]}]}}}}
