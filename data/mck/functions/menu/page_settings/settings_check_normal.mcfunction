...
execute unless data storage menu inv[{"Slot":20b}] run function mck:menu/page_settings/setting1
execute unless data storage menu inv[{"Slot":24b}] run scoreboard players set clear mck_temp 1
execute unless data storage menu inv[{"Slot":24b}] run function mck:menu/page_settings/setting2
execute unless data storage menu inv[{"Slot":29b}] run scoreboard players set clear mck_temp 1
execute unless data storage menu inv[{"Slot":29b}] run function mck:menu/page_settings/setting3
