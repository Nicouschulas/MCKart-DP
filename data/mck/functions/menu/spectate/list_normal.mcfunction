...
execute if score temp mck_temp matches 1 run data modify block 0 0 0 Items[0].components.lobby set value 1
execute if score temp mck_temp matches 1 run item replace entity @s inventory.9 from block 0 0 0 container.0
execute if score temp mck_temp matches 2 run data modify block 0 0 0 Items[0].components.lobby set value 2
execute if score temp mck_temp matches 2 run item replace entity @s inventory.10 from block 0 0 0 container.0
execute if score temp mck_temp matches 3 run data modify block 0 0 0 Items[0].components.lobby set value 3
execute if score temp mck_temp matches 3 run item replace entity @s inventory.11 from block 0 0 0 container.0
execute if score temp mck_temp matches 4 run data modify block 0 0 0 Items[0].components.lobby set value 4
execute if score temp mck_temp matches 4 run item replace entity @s inventory.12 from block 0 0 0 container.0
execute if score temp mck_temp matches 5 run data modify block 0 0 0 Items[0].components.lobby set value 5
execute if score temp mck_temp matches 5 run item replace entity @s inventory.13 from block 0 0 0 container.0
execute if score temp mck_temp matches 6 run data modify block 0 0 0 Items[0].components.lobby set value 6
execute if score temp mck_temp matches 6 run item replace entity @s inventory.14 from block 0 0 0 container.0
execute if score temp mck_temp matches 7 run data modify block 0 0 0 Items[0].components.lobby set value 7
execute if score temp mck_temp matches 7 run item replace entity @s inventory.15 from block 0 0 0 container.0
execute if score temp mck_temp matches 8 run data modify block 0 0 0 Items[0].components.lobby set value 8
execute if score temp mck_temp matches 8 run item replace entity @s inventory.16 from block 0 0 0 container.0
execute if score temp mck_temp matches 9 run data modify block 0 0 0 Items[0].components.lobby set value 9
