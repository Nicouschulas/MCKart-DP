...
execute if score tracks mck_temp matches 1.. run data modify block 0 0 0 Items[0].components set from storage temp cups[0][0].tag.data.icon.tag  
execute if score tracks mck_temp matches 1.. run data modify block 0 0 0 Items[0].components.data.id set from storage temp cups[0][0].tag.data.id  
execute if score tracks mck_temp matches 1.. run data modify block 0 0 0 Items[0].components.menu set value 1b  
execute if score tracks mck_temp matches 1.. run data modify block 0 0 0 Items[0].components.killme set value 1b  
...
execute if score tracks mck_temp matches 1.. unless data storage temp tracks[0] run data modify block 0 0 0 Items[0].components.Enchantments append value {}  
...
execute if score tracks mck_temp matches 1.. run data modify storage temp name append from block 0 0 0 Items[0].components.display.Name  
