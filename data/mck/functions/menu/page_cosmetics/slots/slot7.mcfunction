...
item replace entity @s inventory.24 from block 0 0 0 container.0

execute if data storage temp list[0].data.children[0] run item replace entity @s inventory.15 with gold_nugget{display:{Name:'{"text":" "}'},menu:1b,killme:1b,CustomModelData:137}
